...
#Region "Var"
    ...
    Private m_PasswordKey As String = System.Configuration.ConfigurationManager.AppSettings("fileencryptionkey")
...
#Region "Methods"
    ...
    Public Function EncryptDecryptStream(pStreamIn As System.IO.Stream, Direction As CryptoAction) As System.IO.Stream
        ...
        Dim nFileLength As Long = pStreamIn.Length
        ...
        While nBytesProcessed < nFileLength
            iBytesInCurrentBlock = pStreamIn.Read(byteBuffer, 0, 4096)
